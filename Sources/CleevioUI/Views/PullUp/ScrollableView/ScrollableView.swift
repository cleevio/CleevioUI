...
struct ScrollableView<Content: View>: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIScrollView {
        ...
        context.coordinator.hostingViewController = hostViewController
        let hostContent = hostViewController.view ?? UIView()
        
        hostContent.translatesAutoresizingMaskIntoConstraints = false
        contentView.translatesAutoresizingMaskIntoConstraints = false
        scrollView.addSubview(contentView)

        contentView.addSubview(hostContent)

        hostContent.topAnchor.constraint(equalTo: contentView.topAnchor).isActive = true
        hostContent.leadingAnchor.constraint(equalTo: contentView.leadingAnchor).isActive = true
        hostContent.trailingAnchor.constraint(equalTo: contentView.trailingAnchor).isActive = true
        hostContent.bottomAnchor.constraint(equalTo: contentView.bottomAnchor).isActive = true
    ...
    func updateUIView(_ uiView: UIScrollView, context: Context) {
        context.coordinator.hostingViewController?.rootView = content
    }
